...
const AppRoutes = [
  ...
  {
    path: '/apps/ecommerce/profile',
    exact: true,
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/profile'))

  },
  {
    path: '/apps/ecommerce/categories',
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/categories'))
  },
  /*{
    path: '/apps/ecommerce/items',
    exact: true,
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/items'))
  },*/
  {
    path: '/apps/ecommerce/items/:id',
    exact: true,
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/items'))
  },
  {
    path: '/apps/ecommerce/item/:catid',
    exact: true,
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/items'))
  },
  {
    path: '/apps/ecommerce/restaurants',
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/restaurants'))
  },
  {
    path: '/apps/ecommerce/addRestaurant',
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/addRestaurant'))
  },
  {
    path: '/apps/ecommerce/UserLogin',
    exact: true,
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/guestUser'))
  },
  {
    path: '/apps/ecommerce/Login',
    exact: true,
    className: 'ecommerce-application',
    component: lazy(() => import('../../views/apps/ecommerce/login'))
  },
  {
    path: '/apps/ecommerce/Register',
    exact: true,
    className: 'ecommerce-application',
